...
export default function Table ({ currentTurn, setTurn, assign, match, setMatch, win, setWinner }) {
  // Bloque de codigo que define cuando la computadora le toca hacer su movimiento
  useEffect(() => {
  ...
  const moveUser = (isValid, index) => {
    // Si la casiila esta ocupada, es turno de la computadora, o hay un ganador no se ejecuta nada
